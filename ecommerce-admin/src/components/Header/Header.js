              ...
              <ul className="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li className="nav-item dropdown">
                  ...
                  <a id="notifications" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="nav-link">
                    ...
                    <span className="badge bg-red badge-corner">1</span>
                  </a>
                  <ul aria-labelledby="notifications" className="dropdown-menu">
                    ...
                    <li>
                      <Link rel="nofollow" to="#" className="dropdown-item all-notifications text-center">
                        {" "}
                ...
                {/* Languages dropdown    */}
                <li className="nav-item dropdown">
                  <a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="nav-link language dropdown-toggle">
                    <img src="https://i.ibb.co/QrtCN5s/GB.png" alt="English" />
                  ...
                  <ul aria-labelledby="languages" className="dropdown-menu">
                    <li>
                      <Link rel="nofollow" to="#" className="dropdown-item">
                        {" "}
                        <img src="https://i.ibb.co/QrtCN5s/GB.png" alt="English" className="mr-2" />
                        German
                      </Link>
                    </li>
                    <li>
                      <Link rel="nofollow" to="#" className="dropdown-item">
                        {" "}
                        <img src="https://i.ibb.co/SnpwbfX/VN.png" alt="English" className="mr-2" />
                        Viet Nam
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="nav-item">
                  <Link onClick={this.logOut} to="/login" className="nav-link logout">
                    {" "}
