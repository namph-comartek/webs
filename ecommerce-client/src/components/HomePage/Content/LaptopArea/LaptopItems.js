          ...
          <div className="product_desc">
            <div className="product_desc_info">
              <div className="product-review">
                ...
                <div className="rating-box">
                  <ul className="rating">
                    <BeautyStars size={10} activeColor={"#ed8a19"} inactiveColor={"#c1c1c1"} value={sumRating} editable={false} />
                  </ul>
                </div>
              </div>
              <h4>
                <Link className="product_name text-truncate" to={`/products/${product.id}`}>
                  {product.nameProduct}
                </Link>
              </h4>
            ...
            <div className="add-actions">
              <ul className="add-actions-link">
                ...
                <li>
                  <Link onClick={(id) => this.getInfoProduct(product.id)} to={`/products/${product.id}`} title="quick view" className="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter5">
                    <i className="fa fa-eye" />
                  </Link>
                </li>
                <li>
                  <Link onClick={(id) => this.addItemToFavorite(product.id)} className="links-details" to="#">
                          ...
                          <form className="cart-quantity" onSubmit={(event) => this.addItemToCart2(event, getProduct)}>
                            <div className="quantity">
                              ...
                              <div className="cart-plus-minus">
                                <input type="text" className="cart-plus-minus-box" name={quantity} value={quantity} onChange={this.handleChange} />
